...
class LunarDb
{
    ...
    public static $defaultDate = [1891, '正月', '初一', '辛卯', 1, 1, '兔'];
    ...
    public static $dateHash = ['十', '一', '二', '三', '四', '五', '六', '七', '八', '九'];
    public static $tenDateHash = ['初', '十', '廿'];
    public static $monthHash = ['正月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '冬月', '腊月'];
